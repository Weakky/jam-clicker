...
export function prettifyNumber(n, trailingZeroes = false) {
  ...
  const numbers = [
    ...
    { name: "milliard", value: BigNumber("1000000000") },
    ...
    {
      name: "decillion",
      value: BigNumber("1000000000000000000000000000000000")
    },
    {
      name: "undecillion",
      value: BigNumber("1000000000000000000000000000000000000")
    },
    {
      name: "duodecillion",
      value: BigNumber("1000000000000000000000000000000000000000")
    },
    {
      name: "tredecillion",
      value: BigNumber("1000000000000000000000000000000000000000000")
    },
    {
      name: "quattuordecillion",
      value: BigNumber("1000000000000000000000000000000000000000000000")
    },
    {
      name: "quindecillion",
      value: BigNumber("1000000000000000000000000000000000000000000000000")
    }
  ];
  ...
  let decimalPart = BigNumber(bigN).number.slice(
    (integerDigits + 3) * -1,
    integerDigits * -1
  );
...
export function updateTitleTag(nanites) {
  document.getElementsByTagName("title")[0].text =
    prettifyNumber(BigNumber(nanites).div(100)) + " nanites - Nanite Clicker";
}
